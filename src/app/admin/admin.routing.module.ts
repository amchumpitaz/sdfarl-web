...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'incidencia', component: ProductosComponent },
            { path: 'incidencia/mantenimiento', component: ProductosMantenimientoComponent },
            ...
            { path: 'usuarios/mantenimiento', component: UsuariosMantenimientoComponent },
