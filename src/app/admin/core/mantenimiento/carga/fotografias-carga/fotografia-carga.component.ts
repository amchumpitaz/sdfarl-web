...
import { MENU_FOTOGRAFIA, VALID_ARCHIVE, PROCCESSING_DATA, INVALID_ARCHIVE, PROCESSING_PROCESS } from 'src/app/shared/constants/main.constants';
...
@Component({
  selector: 'app-fotografia-carga',
  templateUrl: './fotografia-carga.component.html',
  styleUrls: ['./fotografia-carga.component.scss']
})
export class FotografiaCargaComponent implements OnInit, OnDestroy {
  ...
  procesoCarga(): void {
    ...
    // this.textModalProcess = this.translate.instant(PROCESS_COMPLETED);
  ...
  getDetalleSubidaFotos(id: number) {
    console.log('Entrando a obtener el detalle de la subida de las fotos');
    console.log(id);
  }
